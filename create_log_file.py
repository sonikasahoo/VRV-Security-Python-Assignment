...
# The log_data is defined as a multi-line string
# Each line is a log entry consisting [IP address, Timestamp, HTTP Path, Status Code, Response size, Custom text msg(optional)]
...
# Name of the log_file to be created
file_name = "sample.log"


# Open the file in write mode('w') and write the log_data in the new file "sample.log"
with open(file_name, "w") as log_file:
    log_file.write(log_data)

# To get a message when the file will be created
print(f"Log file '{file_name}' created successfully")